...
<body>
  <div id="container">
    <h1>Booking {{ $booking->booking_status }}</h1>
    ...
    <p class="title"><span class="titleName">Amount: </span><span>${{ $booking->price_for_stay }}</span></p>

    <h3>We have expired your booking due to overdue payment.</h3>
  </div>
</body>
