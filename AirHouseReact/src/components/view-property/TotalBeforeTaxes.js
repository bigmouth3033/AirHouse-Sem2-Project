...
const TotalBeforeTaxes = ({
    ...
    const onSubmit = (ev) => {
        ...
        const siteFees =
            data.base_price * (calBookedLength(value[0], value[1]) + 1) * 0.06;
        const total =
            data.base_price * (calBookedLength(value[0], value[1]) + 1);
        formData.append("total", total);
        formData.append("site_fees", siteFees);
                ...
                >
                    <StyledCalendar onClick={handleCalendarClick}>
                        <Calendar
                            ...
                            view={"month"}
                            minDate={
                                new Date(start_date) - new Date() > 0
                                    ? new Date(start_date)
                                    : new Date()
                            }
                                ...
                                <StyledAddSub
                                    onClick={() => {
                                        if (guest < data.accomodates_count) {
                                            ...
                                            alert(
                                                `maximum guest is ${data.accomodates_count}`
                                            );
                                        }
                                    }}
                                >
                    ...
                    <div className="container">
                        <div className="content">
                            ...
                            <span>
                                ${" "}
                                {data.base_price *
                                    (calBookedLength(value[0], value[1]) + 1)}
                            </span>
                        </div>
                        <div className="content">
                            <span>
                                {calBookedLength(value[0], value[1]) + 1} night
                            </span>
                        </div>
                        <div className="content">
