    ...
    return (
        <StyledContainer>
            <StyledSection>
                ...
                <StyledDetailInfor>
                    <StyledSpan>
                        <span>{data.accomodates_count} guests </span>{" "}
                        <span> . </span>
                    </StyledSpan>
                    <StyledSpan>
                        <span>{data.bedroom_count} bedrooms</span>{" "}
                        <span> . </span>
                    </StyledSpan>
                    <StyledSpan>
            ...
            <StyledSection>
                <StyledHost
                    onClick={() =>
                        window.open(
                            `/profile/dashboard/${data.user.id}`,
                            "_blank"
                        )
                    }
                >
                    ...
                    <div className="host-container">
                        <p className="hosted">
                            Hosted by {data.user.first_name}{" "}
                            {data.user.last_name}
                        </p>
                        <p>
                            Since{" "}
            ...
            <StyledSection>
                ...
                {data.video && (
                    <div>
                        ...
                        >
                            Welcome to the Extraordinary Moments at Our
                            Property!
                        </StyledA>
                    </div>
                )}
            ...
            <StyledSection>
                ...
                <StyledP>
                    {data.province.name_en}, {data.district.name_en}{" "}
                    {data.address}
                </StyledP>
            </StyledSection>
            {/* khúc này sửa lai */}
            <StyledHouse>
                ...
                <StyledSectionTow>
                    <div>
                        <StyledP>Check-in after: 12PM </StyledP>
                    ...
                    <div>
                        <StyledP>
                            {data.accomodates_count} guests maximum
                        </StyledP>
                    </div>
                </StyledSectionTow>
            </StyledHouse>
